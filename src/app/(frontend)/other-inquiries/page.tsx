...
export const metadata = {
  ...
  description:
    'Contact Us Other Inquiries. Have any queries about homes, neighborhoods, or designs? We are here for you to assist and provide the answers you need. Reach out to us!',
}
...
export default async function OtherInquiriesPage() {
  ...
  const cmsData = pageDoc?.otherInquiriesPage || {}
  const layoutBlocks = pageDoc?.layout || []

  const title = cmsData.title || 'Contact Us'
  const subheading = cmsData.subheading || 'Other Inquiries'
  const description =
    cmsData.description ||
  ...
  const heroImage =
    cmsData.image && typeof cmsData.image === 'object' && cmsData.image.url
      ? cmsData.image.url
      : cmsData.imageUrl || '/media/other-inquiries-hero.webp'
  ...
  return (
    <div style={{ backgroundColor: '#ffffff', minHeight: '100vh', color: '#1a1a1a' }}>
      {/* DEFAULT SPLIT HERO SECTION (rendered unless replaced by a dragged inquiryHero block) */}
      {!hasInquiryHeroInBlocks && (
        <section
          ...
          className="nsh-other-inquiries-section"
        >
            ...
            <div style={{ maxWidth: '620px', width: '100%' }}>
              ...
              >
                ...
                <div style={{ marginTop: '0.5rem' }}>
                  <button
                    type="submit"
                    className="nsh-other-inquiries-btn"
                    style={{
      ...
      {/* DYNAMIC DRAGGABLE CMS LAYOUT BLOCKS */}
      ...
      <style>{`
        .nsh-other-inquiries-btn:hover {
          background-color: #262626 !important;
        }
        @media (max-width: 921px) {
          .nsh-other-inquiries-section {
            flex-direction: column !important;
            min-height: auto !important;
          }
          .nsh-other-inquiries-image {
            width: 100% !important;
            min-height: 350px !important;
            height: 350px !important;
          }
          .nsh-other-inquiries-content {
            width: 100% !important;
